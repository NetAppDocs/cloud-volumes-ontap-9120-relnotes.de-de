...
* link:media/notice-aws.pdf["Hinweis zum Cloud Volumes ONTAP 9.12.0-Mediator in AWS"^]
* link:media/notice-google-cloud.pdf["Hinweis zum Mediator von Cloud Volumes ONTAP 9.12.0 in Google Cloud"^]
