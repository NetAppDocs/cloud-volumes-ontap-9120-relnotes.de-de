...
. Informationen zur regionalen Unterstützung von Google Cloud Platform finden Sie unter https://cloud.netapp.com/cloud-volumes-global-regions["Cloud Volumes Regionen Weltweit"^].
